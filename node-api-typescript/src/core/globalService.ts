...
export default {
  ...
  getEmailMessages = (templatePath: any, callback: any) => {
    fs.readFile(
      templatePath, {
        encoding: "utf-8",
      },
  ...
  replaceMarker = (markerData: any, messages:any, callBack:any) => {
  ...
  emailSend = async (emailData: any, mainCb: any) => {
